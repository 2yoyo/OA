	...
	<form action="sdsdsds" method="post" class="form form-horizontal" id="form-dept-add">
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="java教学部" placeholder="" id="dname" name="dname" datatype="*2-16" nullmsg="部门名不能为空">
			</div>
			<div class="col-4"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-5 skin-minimal">
				<div class="radio-box">
					<input type="radio" checked="checked" id="sex-1" name="dstate" value="1" datatype="*" nullmsg="请选择是否可用">
					<label for="sex-1">可用</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="sex-2" name="dstate" value="0">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="hidden" class="input-text" value="1" id="dparentid" name="dparentid">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" name="dindex" id="dindex" value="1" datatype="n" nullmsg="请输入显示顺序">
			</div>
			<div class="col-4"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<textarea name="ddesc" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="textarealength(this,100)">java牛逼</textarea>
...
$(function(){
	...
	$("#form-dept-add").Validform({
		...
		callback:function(form){  //表单全部验证通过后调用
			submit("deptController/add",form);
