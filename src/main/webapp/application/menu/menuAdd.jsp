	...
	<form action="" method="post" class="form form-horizontal" id="form-menu-add">
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="" placeholder="" id="menuName" name="menuName" datatype="*2-16" nullmsg="不能为空">
			</div>
			<div class="col-4"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="hidden" class="input-text" value="1" id="dparentid" name="menuParentid">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<textarea name="menuDesc" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="textarealength(this,100)">6666这个菜单可牛逼了</textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-5">               <!-- datatype="" nullmsg="请输入显示顺序" -->
				<input type="text" class="input-text" name="menuUrl" id="menuUrl" value="1" >
			</div>
			<div class="col-4"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-5">                   <!-- datatype="" nullmsg="请输入显示顺序" -->   
				<input type="text" class="input-text" name="menuPercore" id="menuPercore" value="1" >
			</div>
			<div class="col-4"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-5 skin-minimal">
				<div class="radio-box">
					...
					value="1" datatype="*" nullmsg="请选择菜单类型">
					<label for="menuType-1">菜单</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="menuType-2" name="menuType" value="0">
...
$(function(){
	...
	$("#form-menu-add").Validform({
		...
		callback:function(form){ 
			...
			submit("menuController/add",form);
